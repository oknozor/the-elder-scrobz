    ...
    <div class="config-form">
        <div class="form-header">
            ...
            <p class="form-description">
                Manage global settings for playlist generation and system behavior.
            </p>
        </div>
                ...
                <div class="checkbox-group">
                    <label class="checkbox-item">
                        ...
                        <span class="checkbox-label">
                            ...
                            <span class="checkbox-description">
                                Automatically generate weekly playlists for users
                            </span>
                        </span>
                    </label>
                    ...
                    <label class="checkbox-item">
                        ...
                        <span class="checkbox-label">
                            ...
                            <span class="checkbox-description">
                                Automatically generate monthly playlists for users
                            </span>
                        </span>
                    </label>
                    ...
                    <label class="checkbox-item">
                        ...
                        <span class="checkbox-label">
                            ...
                            <span class="checkbox-description">
                                Automatically generate yearly playlists for users
                            </span>
                        </span>
                    </label>
                </div>
...
onMounted(async () => {
    try {
        ...
        config.value = { ...adminStore.config };
    } catch (error) {
...
const handleSave = async () => {
    try {
        ...
        await adminStore.updateConfig(config.value);
