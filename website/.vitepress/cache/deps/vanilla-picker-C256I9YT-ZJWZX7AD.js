// node_modules/vitepress-openapi/dist/vanilla-picker-C256I9YT.js
var O = function(l, n) {
  if (!(l instanceof n))
  ...
  function l(n, e, t, r) {
    ...
    function o(a) {
      if (a.startsWith("hsl")) {
        ...
        var v = a.match(/([\-\d\.e]+)/g).map(Number), h = y(v, 4), m = h[0], g = h[1], E = h[2], k = h[3];
        k === void 0 && (k = 1), i.rgba = [m, g, E, k];
      } else
  ...
  return R(l, [{
    ...
    value: function(e) {
      ...
      if (i === 0)
        ...
        var f = function(h, m, g) {
          return g < 0 && (g += 1), g > 1 && (g -= 1), g < 0.16666666666666666 ? h + (m - h) * 6 * g : g < 0.5 ? m : g < 0.6666666666666666 ? h + (m - h) * (0.6666666666666666 - g) * 6 : h;
...
function L(l, n, e) {
  ...
  function i(a, s, p) {
    if (p && (t = true), !!t) {
      a.preventDefault();
      var f = n.getBoundingClientRect(), u = f.width, d = f.height, b = s.clientX, v = s.clientY, h = r(b - f.left, 0, u), m = r(v - f.top, 0, d);
      e(h / u, m / d);
    }
  }
  function o(a, s) {
...
var K = function() {
  ...
  return R(l, [{
    ...
    value: function(e) {
      ...
      b(a, f, r[0]), this._domSL.style.backgroundColor = this._domH.style.color = i, b(s, u, r[1]), v(s, u, 1 - r[2]), s.style.color = o, v(p, d, 1 - r[3]);
      var h = o, m = h.replace("hsl", "hsla").replace(")", ", 0)"), g = "linear-gradient(" + [h, m] + ")";
...
vitepress-openapi/dist/vanilla-picker-C256I9YT.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=vanilla-picker-C256I9YT-ZJWZX7AD.js.map
